...
namespace AlistarMod.Modules
{
    internal static class MyAssets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(AlistarPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
        ...
        internal static GameObject CreateProjectileGhostPrefab(this AssetBundle assetBundle, string ghostName)
        {
            ...
            Modules.MyAssets.ConvertAllRenderersToHopooShader(ghostPrefab);
